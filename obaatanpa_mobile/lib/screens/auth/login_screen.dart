...
class _LoginScreenState extends State<LoginScreen>
  ...
  Widget _buildHeroSection() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        // Fallback color instead of problematic image
  ...
  Widget _buildUserTypeOption(String value, String title, {bool isFirst = false}) {
    ...
    if (success && mounted) {
      ...
      switch (_selectedUserType) {
        case 'pregnant':
          ...
          break;
        case 'new_mother':
          context.go('/dashboard/new-mother');
          break;
        case 'hospital':
          context.go('/dashboard/hospital');
          break;
        case 'practitioner':
